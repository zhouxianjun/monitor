...
export default {
    ...
    watch: {
        activeName (name) {
            ...
            else this.openedNames = Array.from(new Set([...this.openedNames, ...this.getOpenedNamesByActiveName(name)]));
        },
        openNames (newNames) {
    ...
    mounted () {
        this.openedNames = Array.from(new Set([...this.openedNames, ...this.getOpenedNamesByActiveName(name)]));
    },
    methods: {
        handleSelect (name) {
